...
class ManufacturerViewController: BaseViewController<ManufacturerViewModel> {
    ...
    override func viewDidLoad() {
        self.title = "manufacturer_screen_title".localized
        self.viewModel = ManufacturerViewModel()
